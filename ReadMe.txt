2021/10/31 14:30
★不具合を修正　ステージ5、ステージ7の外観修正
・ステージ5にてマテリアル重なりによる点滅を修正
・ステージ7のベルトコンベアのアニメーション向きを修正

2021/10/30 22:58
★プロジェクト名の変更
【変更前】
main_scene\CalamariTape
【変更後】
Morumotto_Wheerun_Main

2021/10/30 22:30
★不具合修正　ステージの見た目、ポーズ画面
・ポーズ画面表示中にモード変更が出来てしまう不具合を修正
・ステージ6の復帰ルートを短く調整
・ステージ7
　ベルトコンベアのアニメーションの向きを修正
　スタート付近にあるベルトコンベアからジャンプ先の足場を調整
・ステージ8のロープ位置の高さを調整

2021/10/30 0:13
★不具合修正　ターザン
・ロープに掴まった状態から飛ぶ際にかかる重力を一定にする

2021/10/29 22:10
★不具合修正　ケージで回転
・ステージ10、ステージ6にてケージで回転中にポーズ画面表示で止まらない不具合を修正

2021/10/29 18:50
★不具合修正　各ステージのUI調整、クリアロゴの最新差し替え
・ステージ1～9のポーズ画面、クリア画面にて項目UIの位置調整、選択UIの大きさと位置調整、クリアロゴの差し替え
・ステージ10のポーズ画面、クリア画面にて項目UIの位置調整、選択UIの大きさと位置調整、congratulationロゴの差し替え
・ステージ10のベルトコンベアにてジャンプできるよう修正

2021/10/29 14:47
★不具合修正　ターザン、回転リング、ダッシュパネル、ケージで回転の不具合を修正
・回転リングのプレハブ情報を変更（タグ追加）
・ステージ6、ステージ10のケージで回転のエリア範囲を調整
・ダッシュパネルでダッシュ中に落下した際に、ダッシュがオフになる対応
・回転リングの挙動をポーズ画面、クリア画面を開いた際に止めるよう実装
・ターザンにてロープから離れて振り子の動きが治まる前に掴んでも再び振り子が揺れるよう修正

2021/10/29 10:19
★不具合修正　新ギミックの不具合を修正
・動く壁（縦向き｜横向き）のタグ情報を修正してポーズ画面にて止まるようにする
・ステージ3の落下復帰エリアの拡大
・ステージ4のトランポリン3連箇所を明るくする
・ステージ6へ復帰ルート追加、ケージ回転扉の開く角度の調整
・ステージ7のベルトコンベア上でジャンプできるよう修正
